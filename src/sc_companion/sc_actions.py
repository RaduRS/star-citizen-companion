"""Safety + execution layer for keyboard actions in Star Citizen."""
...
def is_sc_foreground() -> bool:
    """True if the active foreground window is Star Citizen."""
    try:
    ...
    return "star citizen" in title or title.startswith("starcitizen")
...
def execute_action(
    ...
    *,
    dry_run: bool = False,
    require_sc_foreground: bool = True,
    ...
    if require_sc_foreground and not is_sc_foreground():
        return False, "Star Citizen is not the foreground window"
    if dry_run:
